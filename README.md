...
I trained DiT models by ImageNet. To download it, register huggingface and request  permission in [ImageNet](https://huggingface.co/datasets/ILSVRC/imagenet-1k).
